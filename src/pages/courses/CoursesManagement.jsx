...
export default function CoursesManagement() {
  ...
  const canManage = hasRole("tmhrt_kfl") || hasRole("super_admin");
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        {canManage && (
          <button
            ...
            className="flex items-center gap-2 bg-linear-to-r from-brand-600 to-brand-500 text-white px-5 py-2.5 rounded-xl font-bold shadow-lg shadow-brand-500/30 hover:-translate-y-0.5 transition-all"
          >
      ...
      <div className="glass-panel p-3 flex flex-wrap sm:flex-nowrap gap-3 items-center">
        ...
        <div className="relative w-full sm:w-64">
          ...
          >
            <option value="">
              {t("common.all")} {t("common.programType")}
            </option>
            {programTypes.map((pt) => (
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-slate-50/50 border-b border-slate-200/60 text-slate-500 text-sm tracking-wide">
              ...
              <th className="px-6 py-4 font-semibold">
                {t("courses.fields.programType")}
              </th>
              <th className="px-6 py-4 font-semibold">
                {t("courses.fields.creditHour")}
              </th>
              <th className="px-6 py-4 font-semibold">
          ...
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              <tr>
                <td
                  colSpan="5"
                  className="text-center py-10 font-medium text-slate-500"
                >
                  {t("common.loading")}
                </td>
              </tr>
              ...
              filtered.map((course) => {
                ...
                const weightsSum = assessments.reduce(
